 ...
 */
final class Version20231031134621 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE token_registration_life_time token_registration_life_time DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL');
    }
}
